...
try {
    ...
    if (isset($_POST['email']) && isset($_POST['password'])) {
        // $res = mail($inputEmail, 'Account locked', 'Please click the link to unlock your account: ' . 'http://localhost:8080/assignmentPHP/unlock.php');
        // echo var_dump($res);
        ...
        if ($query->num_rows > 0) {
            ...
            if (password_verify($inputPassword, $row['passwordHash'])) {
                ...
                if ($_SESSION['attempt'] == 3) {
                    ...
                    mail($inputEmail, 'Account locked', 'Please click the link to unlock your account: ' . 'http://localhost:8080/assignmentPHP/unlock.php');
